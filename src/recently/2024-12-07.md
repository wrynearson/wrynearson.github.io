...
{% image "./src/assets/img/recently/india_1.JPG", "An outdoor window frame", "(min-width: 30em) 50 vw, 100vw" %}

{% image "./src/assets/img/recently/india_2.JPG", "Preparing flower wreaths", "(min-width: 30em) 50 vw, 100vw" %}
...
{% image "./src/assets/img/recently/india_3.JPG", "Thali", "(min-width: 30em) 50 vw, 100vw" %}
