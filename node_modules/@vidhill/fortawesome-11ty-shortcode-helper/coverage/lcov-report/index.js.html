...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { library, icon, toHtml } from '@fortawesome/fontawesome-svg-core';
&nbsp;
/**
 *
...
function makeFortawesomeShortcode(iconSet, iconSetPrefix) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!iconSet[iconSetPrefix]) {
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid arguments passed');</span>
    }
...
&nbsp;
        const options = additionalClasses ? { classes: additionalClasses } : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!iconResult) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Jun 08 2021 18:48:46 GMT+0100 (Irish Standard Time)
            </div>
        </div>
