...
const fortawesomeFreeRegularShortcode = helpers.makeFortawesomeShortcode(freeRegularIcons, 'far');

function fortawesomeFreeRegularPlugin(eleventyConfig) {
  eleventyConfig.addShortcode('fortawesomeRegular', fortawesomeFreeRegularShortcode);
}
